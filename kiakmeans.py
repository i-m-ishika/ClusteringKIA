...
Original file is located at
    https://colab.research.google.com/drive/195sVosqKs7KHKzCr-k8IKOzdcthXtXlo
"""
...
def makeClusters(pop,mi,data,k,alpha,rand):
  ...
  #randomly initialize 20 solutes
  for i in range(20):
    l=[]
    for j in range(n):
      r=random.uniform(lb,ub)
  ...
  #initialize 30 solutes with KMeans 
  for i in range(30):
    l=[]
    kmeans = KMeans(n_clusters = k, random_state = i).fit(data)
...
clusters=[]
solute=[]
numIter=100 #int(input("Enter number of iterations  "))
k=3 #int(input("Enter number of clusters  "))
numAttr=data.shape[1]
#pop = 50
...
str1='KMeansResult'+str(numIter)+'.csv'
